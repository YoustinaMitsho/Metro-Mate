...
void SignupPage::on_signup_clicked()
{
    ...
    if(!ui->name->text().isEmpty() && !ui->pass->text().isEmpty() && !ui->mail->text().isEmpty() && !ui->card->text().isEmpty() && !ui->balance->text().isEmpty())
    {
        ...
        if(check == true )
        {
            ...
            int balanceValue = ui->balance->text().toInt(&isInteger);
