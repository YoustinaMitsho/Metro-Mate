...
"border-radius: 12;"));
        ...
        label_21->setGeometry(QRect(280, 40, 201, 41));
...
"border-radius: 12;\n"
"color: black;"));
        editStation = new QPushButton(groupBox_2);
        editStation->setObjectName("editStation");
        editStation->setGeometry(QRect(250, 640, 251, 41));
        editStation->setFont(font1);
        editStation->setStyleSheet(QString::fromUtf8("background-color: #FFC200;\n"
"border-radius: 12;\n"
"color: black;"));
        pushButton_21->raise();
        ManageMetro->raise();
    ...
    void retranslateUi(QDialog *AdminManageMetroOtions)
    {
        ...
        editStation->setText(QCoreApplication::translate("AdminManageMetroOtions", "Edit Station", nullptr));
    } // retranslateUi
