...
"color: black;"));
    ...
    void retranslateUi(QDialog *Subscription)
    {
        ...
        label_16->setText(QCoreApplication::translate("Subscription", "Remaining Rides", nullptr));
        ...
        label_17->setText(QCoreApplication::translate("Subscription", "Remaining Balance", nullptr));
