...
"border-radius: 10;"));
    ...
    void retranslateUi(QDockWidget *removesub)
    {
        ...
        start->setItemText(0, QCoreApplication::translate("removesub", "Public", nullptr));
        start->setItemText(1, QCoreApplication::translate("removesub", "Student", nullptr));
        start->setItemText(2, QCoreApplication::translate("removesub", "Wallet", nullptr));
