...
"color: black;"));
        ...
        label_6->setGeometry(QRect(60, 390, 151, 51));
        label_6->setFont(font);
        mail = new QLineEdit(groupBox);
        mail->setObjectName("mail");
        mail->setGeometry(QRect(250, 400, 291, 41));
