...
void stat1month::display()
{
    qDebug()<<"this user"<<UserClass::thisuser.Username;
    ui->money->setText(QString::number(Statistics::calculateTotalIncome()));
    ui->average->setText(QString::number(Statistics::calculateAverageUserCost()));
    ui->max->setText(QString::number(Statistics::findMaxCost()));
    ui->min->setText(QString::number(Statistics::findMinCost()));
}
